...
const new-front-end = document.getElementById('new-front-end');
const new-back-end = document.getElementById('new-back-end');
const new-db = document.getElementById('new-db');
const whole-new-blog = document.getElementById('whole-new-blog');
